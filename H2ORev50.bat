...
set INCLUDE=%VC_PATH%\VC\Include;%SDK_DIR%\Include;%SDK_DIR%\Include\um;%SDK_DIR%\Include\shared
set LIB=%VC_PATH%\VC\Lib;%SDK_DIR%\Lib;%SDK_DIR%\Lib\win8\um\x86;%SDK_DIR%\Lib\winv6.3\um\x86
