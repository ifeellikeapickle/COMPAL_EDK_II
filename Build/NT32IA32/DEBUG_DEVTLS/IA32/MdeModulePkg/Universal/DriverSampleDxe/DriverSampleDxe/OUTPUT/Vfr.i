#line 1 "q:\\MdeModulePkg\\Universal\\DriverSampleDxe\\Vfr.vfr"
...
#line 18 "q:\\MdeModulePkg\\Universal\\DriverSampleDxe\\Vfr.vfr"
...
formset
  ...
  namevaluevarstore MyNameValueVar,                
    name = STRING_TOKEN(0x0075), 
    name = STRING_TOKEN(0x0076), 
  ...
  form formid = 1,                                
    ...
    suppressif ideqval MyIfrNVData.SuppressGrayOutSomething == 0x0;
      ...
      orderedlist
                ...
                option text = STRING_TOKEN(0x0072), value = 2, flags = 0;
                option text = STRING_TOKEN(0x0071), value = 1, flags = 0;
                option text = STRING_TOKEN(0x0073), value = 3, flags = 0;
              suppressif ideqval MyIfrNVData.BootOrderLarge == 0;
                option text = STRING_TOKEN(0x0074), value = 4, flags = 0;
              endif
      endlist;
    ...
    oneof varid  = MyIfrNVData.TestLateCheck,
      ...
      warningif prompt = STRING_TOKEN(0x008F), timeout = 5,
  ...
  form formid = 3, title = STRING_TOKEN(0x0017);  
    ...
    grayoutif  match2 (stringref(STRING_TOKEN(0x0093)), stringref(STRING_TOKEN(0x0092)), { 0x63E60A51, 0x497D, 0xD427, {0xC4, 0xA5, 0xB8, 0xAB, 0xDC, 0x3A, 0xAE, 0xB6 }});
      numeric 
  ...
  formmap formid = 4,            
    ...
    oneof varid = MyIfrNVData.SerialPortNo,    
      ...
      option text = STRING_TOKEN(0x007B), value = 0x0, flags = DEFAULT;
      option text = STRING_TOKEN(0x007C), value = 0x1, flags = 0;
      option text = STRING_TOKEN(0x007D), value = 0x2, flags = 0;
      option text = STRING_TOKEN(0x007E), value = 0x3, flags = 0;
      option text = STRING_TOKEN(0x007F), value = 0x4, flags = 0;
    endoneof;
    ...
    grayoutif TRUE;
      suppressif ideqval MyIfrNVData.SerialPortStatus == 0;
        oneof varid = MyIfrNVData.SerialPortIo,    
          ...
          option text = STRING_TOKEN(0x0083), value = 0x3F8, flags = DEFAULT;
          option text = STRING_TOKEN(0x0084), value = 0x2F8, flags = 0;
          option text = STRING_TOKEN(0x0085), value = 0x3E8, flags = 0;
          option text = STRING_TOKEN(0x0086), value = 0x2E8, flags = 0;
        endoneof;
      endif;
    endif;
    ...
    grayoutif TRUE;
      suppressif ideqval MyIfrNVData.SerialPortStatus == 0;
        oneof varid = MyIfrNVData.SerialPortIrq,    
          ...
          option text = STRING_TOKEN(0x0087), value = 0x4, flags = DEFAULT;
          option text = STRING_TOKEN(0x0088), value = 0x3, flags = 0;
        endoneof;
      endif;
    endif;
